									...
									<!-- Sidebar -->
										<div class="sidebar">
											...
											<section class="formulario">
												...
												<p>Aquí puedes ver las operaciones relacionadas a las ventas de productos, puedes ingresar tus ventas de productos, eliminar y modificar.</p>
	...
	<input name="showFRMdet" class="special" value="Regresar" type="submit" >
                                                ...
                                                ?>
                                                    <form name="frmEditar" action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="post">
														...
														<br>
														<br>
                                                        <a href="venta.php" class="button special">Regresar</a>
                                                ...
                                                <?php
                                                        ...
                                                        //eliminar
														 $sql="DELETE FROM  `Combo` WHERE `id`='".$_POST['btnDel']."';";
                                                            $con -> query($sql);
                                                    ?>
                                                            <a href="venta.php" class="button special">Datos eliminados. Regresar</a>
                                                    <?php
                                                        //añadir
                                                    }elseif(isset($_POST['btnAdd'])){
...
?>
                                                <?php
															...
															$sql = "SELECT nit FROM `Clientes` where id >1;";
                                                            if($resultado = $con -> query($sql)){
												?>
                                                    <form name="frmaddVenta" action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="post">
                                                        <label>Nit Cliente: </label>
                                                        <input list="nits"  value="C/F" name="lsProv" onchange="alert(this.value);" required>
                                                            <datalist id="nits">
                                                                ...
                                                                ?>
																<option value="<?php echo $obj->id ; ?>">"<?php echo $obj->nit ; ?>"</option>
                                                                <?php
                                                                }
                                                                ?>
														...
														<?php
                                                                ...
                                                                ?>
														<br>
														<span id="datosClientes">
															<label>Nombre:</label>
															<input type="text" name="txtNombre" value="S/N" disabled>
															<label>Dirección:</label>
															<input type="text" name="txtDir" value="S/D" disabled>
														</span>
														<br>
                                                        <br>
                                                        <input type="hidden" name="btnAdd" value="Añadir">
												...
												<table class="rwd-table">
                                                    ...
                                                    <?php
                                                        //
                                                        $sql="SELECT id, fecha, nit, nombre, direccion, Total FROM `Venta` ORDER by fecha ASC;";
                                                        if($resultado = $con -> query($sql)){
                                                            while($obj = $resultado->fetch_object()){
                                                        ?>
                                                    <tr>
